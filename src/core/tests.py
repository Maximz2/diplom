...
class SignUpTestCase(APITestCase):
    ...
    def test_minimal_required_fields_success(self):
        ...
        self.assertNotEqual(new_user.password, 'fklsdn123')
        self.assertTrue(new_user.check_password('fklsdn123'))
...
class TestUpdatePassword(APITestCase):
    ...
    def test_invalid_old_password(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertDictEqual(response.json(), {'non_field_errors': ['field is incorrect']})
